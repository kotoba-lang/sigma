...
if (web.kotobaArtifact.requiredCapabilities.length !== 0)
  throw new Error("sigma bounded-vocabulary Web graph requested a capability");
if (web.instantiateKotoba().main() !== 42n) throw new Error("sigma Web main mismatch");
...
if (wasm.instance.exports.main() !== 42n) throw new Error("sigma Wasm main mismatch");

console.log("sigma: bounded vocabulary+registry Web/Wasm conformance passed");
